...
set -U fish_user_paths $HOME/.local/bin $HOME/.emacs.d/bin /usr/local/go/bin $HOME/.cargo/bin $HOME/.dotnet/tools $HOME/go/bin /usr/lib/go/src $HOME/Documents/java_lang_server/bin $fish_user_paths
#set PATH $PATH:$HOME/.local/bin:$HOME/.emacs.d/bin
set EDITOR "nvim"
set -Ux HF_TOKEN "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"
