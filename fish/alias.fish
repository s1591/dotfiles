...
alias Syyu="sudo dnf update && notify-send 'update completed 🫠' && sudo dnf upgrade"
alias Syyunc="sudo dnf update -y && notify-send 'update completed 🫠' && sudo dnf upgrade -y"
